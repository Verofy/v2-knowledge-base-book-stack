      ...
      return function() {
        var __webpack_modules__ = {
          ...
          4664: function(module2, __unused_webpack_exports, __webpack_require__2) {
            var DESCRIPTORS = __webpack_require__2(9781);
            var fails = __webpack_require__2(7293);
            var createElement2 = __webpack_require__2(317);
              ...
              if (init2 !== void 0) {
                if (isObject(init2)) {
                  ...
                  if (typeof iteratorMethod === "function") {
                    ...
                    for (key in init2)
                      if (hasOwn(init2, key))
                        entries.push({ key, value: init2[key] + "" });
                } else {
        ...
        !function() {
            ...
            dropzone_createClass(Dropzone3, [{
              ...
              value: function getExistingFallback() {
                ...
                for (var _i = 0, _arr = ["div", "form"]; _i < _arr.length; _i++) {
                  var tagName2 = _arr[_i];
                  var fallback;
                  if (fallback = getFallback(this.element.getElementsByTagName(tagName2))) {
                    return fallback;
                  }
                }
              }
          ...
          var contentLoaded = function contentLoaded2(win, fn) {
            ...
            if (doc.readyState !== "complete") {
              ...
              doc[add](pre + "DOMContentLoaded", init2, false);
              doc[add](pre + "readystatechange", init2, false);
              return win[add](pre + "load", init2, false);
            }
          };
...
var init_punycode_es6 = __esm({
  "node_modules/punycode/punycode.es6.js"() {
    ...
    ucs2encode = (array2) => String.fromCodePoint(...array2);
...
var chapter_contents_default = ChapterContents;
...
var CodeEditor = class {
  ...
  open(code, language, callback) {
    ...
    this.show().then(() => this.languageInputChange(language)).then(() => window.importVersioned("code")).then((Code) => Code.setContent(this.editor, code));
  }
  async show() {
...
var code_textarea_default = CodeTextarea;
...
function init(modules, domApi, options2) {
  const cbs = {
    create: [],
    update: [],
    remove: [],
...
var MarkdownEditor = class {
  ...
  getDisplayTarget() {
    ...
    if (body.children.length === 0) {
      const wrap2 = document.createElement("div");
      this.displayDoc.body.append(wrap2);
    }
  ...
  codeMirrorSetup(cm) {
    ...
    extraKeys[`${metaKey}-P`] = (cm2) => {
      replaceLineStart("-");
    };
    extraKeys[`${metaKey}-O`] = (cm2) => {
...
function register3(editor, url) {
  editor.addCommand("InsertHorizontalRule", function() {
    ...
    let parentNode2 = cNode.parentNode;
...
var componentMapping = {
  ...
  "chapter-contents": chapter_contents_default,
  "code-editor": code_editor_default,
  "code-highlighter": code_highlighter_default,
  "code-textarea": code_textarea_default,
