...
return [
    ...
    'recently_created_shelves' => 'Recently Created Topics',
    ...
    'shelves_edit_named' => 'Edit Topic :name',
    'shelves_edit' => 'Edit Topic',
    'shelves_delete' => 'Delete Topic',
    'shelves_delete_named' => 'Delete Topic :name',
    'shelves_delete_explain' => "This will delete the Topic with the name ':name'. Contained books will not be deleted.",
    'shelves_delete_confirmation' => 'Are you sure you want to delete this topic?',
    'shelves_permissions' => 'Topic Permissions',
    'shelves_permissions_updated' => 'Topic Permissions Updated',
    'shelves_permissions_active' => 'Topic Permissions Active',
    'shelves_permissions_cascade_warning' => 'Permissions on Topic do not automatically cascade to contained books. This is because a book can exist on multiple topics. Permissions can however be copied down to child books using the option found below.',
    'shelves_copy_permissions_to_books' => 'Copy Permissions to topics',
    'shelves_copy_permissions' => 'Copy Permissions',
    'shelves_copy_permissions_explain' => 'This will apply the current permission settings of this topic to all books contained within. Before activating, ensure any changes to the permissions of this bookshelf have been saved.',
    'shelves_copy_permission_success' => 'Topic permissions copied to :count books',
